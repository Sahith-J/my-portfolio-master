// --------- Hero Section
//Logo name
export const logo = "Sahith";
//Name
export const name = "Sahith";
//Tag lines
...
//About
export const about = `Hello, I'm <strong>Sahith Jonnadula</strong>, a passionate and dedicated student hailing from the vibrant city of Warangal, Telangana. Currently in my 3rd year, 1st semester of Computer Science and Engineering at SR University, my journey into the ever-evolving world of technology has been an exhilarating adventure. I've not only accumulated invaluable knowledge but also honed my communication skills and adaptability, which are vital traits in the tech industry. <br /> <br /> As a Computer Science enthusiast, I embarked on this path with a fervent desire for problem-solving, and it's been an incredible ride. The challenges I've faced have only fueled my determination, and the friendships I've forged have provided unwavering support throughout this demanding program. My time at SR University has been marked by engaging projects that have expanded my horizons and fueled my passion for innovation. I look forward to the exciting opportunities that lie ahead in this dynamic field.`;
//Technologies
export const stackList = [
  ...
  {
    img: "https://cdn-icons-png.flaticon.com/128/721/721671.png",
    name: "JavaScript",
  },
  {
  ...
  {
    img: "https://cdn-icons-png.flaticon.com/128/5968/5968322.png",
    name: "NodeJS",
  },
  {
  ...
  {
    img: "https://cdn-icons-png.flaticon.com/128/5968/5968521.png",
    name: "MySQL",
  },
  {
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTwmIjAV-_r9mAsURpyS8tZwthVuwDfFfaqPg&usqp=CAU",
    name: "MongoDB",
  },
  {
  ...
  {
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1SC1ofm2Ht61YIf6kyThVwEBlwuHx-sCZng&usqp=CAU",
    name: "Dart",
  },
  {
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSP1hMXjoed4hpDq1IM1U1FHIkegKKKULqApnJVEjhZyjolBE--bQfEwfzM71E6KSSHbsg&usqp=CAU",
    name: "C",
  },
  {
...
export const ProjectList = [
  ...
  {
    img: "https://miro.medium.com/v2/resize:fit:800/1*8du96SQUQ0NlWmWvVu20Zw.png",
    ...
    demo_url: "https://devkrishnasai.github.io/rock-paper-scissors/",
  },
...
export const CertificateList = [
  {
    ...
    description:
      "Received certification for completing 2 Problem Solving Questions.",
    tech_stack: ["Python", "Problem Solving"],
    credential_url: "https://www.hackerrank.com/certificates/d84c5b22f12b",
  },
  {
    img:"/certif2.png",
    title: "Hackerrank Problem Solving (Intermediate) Certification",
    description:
      "Received certification for completing 2 Problem Solving Questions.",
      tech_stack: ["Python", "Problem Solving"],
    credential_url: "https://www.hackerrank.com/certificates/f1ec1d2a5b08",
  },
...
// -------- Contact Section
// Email
export const email = "sahithjbuis@gmail.com";

//links
export const links = {
  github: "https://github.com/Sahith-J",
  linkedin: "https://www.linkedin.com/in/sahith-jonnadula",
};
